...
exports.up = function (db) {
    return db.runSql(
        ...
        "(1, 'Chatbot', 'Started following a tutorial on how to build a chatbot in PHP using Laravel and Botman.', '2018-06-06', 'https://github.com/ellllllen/chatbot', true, true)," +
        ...
        "(3, 'Automated Testing', 'Researching and implementing automated testing. So writing loads unit, feature and browser tests for my personal website.', '2018-06-21', 'https://github.com/ellllllen/personal-website', true, true), " +
        ...
        "(5, 'Travis CI (Part 1)', 'Implemented Travis CI on my personal website.', '2018-10-11', 'https://travis-ci.com/ellllllen/personal-website', true, true), " +
        "(6, 'Travis CI (Part 2)', 'Managed to implement Browser tests using Travis CI on my personal website. Also added Travis CI to my other repositories.', '2018-11-01', 'https://travis-ci.com/ellllllen', true, true)," +
        ...
        "(10, 'VueJS Testing', 'Following a Laracasts tutorial on how to test VueJS apps: https://laracasts.com/series/testing-vue', '2019-06-13', 'https://github.com/ellllllen/testing-vue', true, true);"
    );
};
